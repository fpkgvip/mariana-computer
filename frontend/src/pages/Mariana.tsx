      ...
      <section className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        <ScrollReveal>
          ...
          <p className="mt-5 max-w-xl text-[16px] leading-[1.7] text-muted-foreground">
            Different questions need different levels of investigation. Select
            the depth that matches your needs when you submit a query.
          </p>
        </ScrollReveal>
          ...
          {[
            {
              name: "Deep Research",
              time: "2–5 minutes",
              desc: "Quick, targeted analysis. Good for specific data lookups, single-filing reviews, and focused questions with known parameters.",
            },
            {
              name: "Superdeep",
              time: "15+ minutes",
              desc: "Multi-source investigation. Cross-references filings, builds simple models, and follows initial evidence chains across related documents.",
            },
            {
              name: "Professional",
              time: "1–2+ hours",
              desc: "Full autonomous research. Writes custom programs, builds statistical models, queries external APIs, and produces comprehensive deliverables.",
            },
            {
              name: "Mariana Flagship",
              time: "12+ hours",
              desc: "Maximum depth. Multi-day autonomous investigation across jurisdictions, with custom tooling, exhaustive source verification, and institutional-grade output.",
            },
          ].map((tier, i) => (
        ...
        <ScrollReveal>
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-[16px] leading-[1.7] text-muted-foreground">
              Start with a single query. Every account gets $5 in free credits.
              If the depth is what your team needs, we'll structure a plan that fits.
            </p>
